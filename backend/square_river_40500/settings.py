"""
Django settings for square_river_40500 project.
...
ROOT_URLCONF = 'square_river_40500.urls'
...
WSGI_APPLICATION = 'square_river_40500.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "square_river_40500 API",
    "DESCRIPTION": "API documentation for square_river_40500 App",
    "VERSION": "v1",
}
